...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2024 at 09:10 AM
...
INSERT INTO `tb_detail_order` (`id_dorder`, `check_available`, `id_order`, `id_masakan`, `keterangan_dorder`, `jumlah_dorder`, `hartot_dorder`, `id_user`, `status_dorde`) VALUES
(64, 1, 'ORD0001', 12, 'pedes', 6, 150000, 8, 0),
(65, 1, 'ORD0001', 16, '', 1, 9000, 8, 0),
(67, 2, 'ORD0002', 13, 'pedes', 5, 150000, 1, 1),
(68, 3, 'ORD0003', 13, '', 1, 30000, 1, 1),
(69, 4, 'ORD0004', 13, 'pedes\r\n', 1, 30000, 1, 1),
(70, 5, 'ORD0005', 12, '&#039;', 1, 25000, 0, 1);
...
('ORD0002', 1, 1704651739, '08-01-2024', 1, '', '0'),
('ORD0003', 2, 1704691690, '08-01-2024', 1, '', '0'),
('ORD0004', 3, 1704691858, '08-01-2024', 1, '', '0'),
('ORD0005', 4, 1704692080, '08-01-2024', 1, '', '0'),
('ORD0006', 5, 1705056771, '12-01-2024', 1, '', '0');
...
(12, 'Didit', '12345678', 'pramuditya', 1);
...
--
ALTER TABLE `tb_detail_order`
  MODIFY `id_dorder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
